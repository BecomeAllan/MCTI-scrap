...
def speciesconservation1(path, keywords = '(brazil|latin america region)'):
    try:
        print('[speciesconservation][oportunidades][start]')
        ...
        print('[speciesconservation][oportunidades][end]')
...
def speciesconservation2(path):
    try:
        print('[speciesconservation][noticias][start]')
        ...
        print('[speciesconservation][noticias][end]')
    except Exception as e:
        print(e)
...
def speciesconservation3(path):
    try:
        print('[speciesconservation][politicas][start]')
        dia = datetime.today().strftime('%y%m%d')
        ...
        df['atualizacao'] = [dia] * len(df.index)
        df.to_csv(path + filename, index = False)
        print('[speciesconservation][politicas][end]')
    except Exception as e:
        print(e)
